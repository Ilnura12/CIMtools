...
known_solvents = (('1-phenylethan-1-one', 'CC(=O)c1ccccc1', 'acetophenone', 'methyl phenyl ketone', 'phenylethanone'),
 ('1,2-dichloroethane', 'ClCCCl', 'ethylene dichloride', '1,2-dca', 'dce', 'ethane dichloride', 'dutch liquid', 'dutch oil', 'freon 150', 'freon-150'),
 ('1,2-dimethoxyethane', 'COCCOC', 'ethane-1,2-diyl dimethyl ether', 'dme', 'glyme', 'ethylene glycol dimethyl ether', 'monoglyme', 'dimethyl glycol', 'dimethyl cellosolve'),
 ('propane-1,2,3-triol', 'OCC(O)CO', '1,2,3-propanetriol', 'glycerin', 'glycerine', 'propanetriol', '1,2,3-trihydroxypropane'),
 ('1,3-dimethylbenzene', 'CC1=CC(C)=CC=C1', '1,3-xylene', '3-xylene', 'isoxylene', 'm-xylene', 'm-xylol', 'Cc1cccc(C)c1'),
 ('1,3,5-trimethylbenzene', 'CC1=CC(C)=CC(C)=C1', 'mesitylene', 'sym-trimethylbenzene'),
 ('1,4-dimethylbenzene', 'Cc1ccc(C)cc1', 'p-xylene', '1,4-xylene', 'p-dimethylbenzene', 'p-xylol', 'p-methyltoluene', 'paraxylene', 'chromar', 'scintillar', '4-methyltoluene', 'nsc 72419'),
 ('1,4-dioxane', 'C1COCCO1', '1,4-dioxacyclohexane', '[1,4]dioxane', 'p-dioxane', '[6]-crown-2',
  'diethylene dioxide', 'diethylene ether', 'dioxan'),
 ('1,4-epoxybutane', 'C1CCOC1', 'oxolane', 'oxacyclopentane', 'tetrahydrofuran', 'butylene oxide', 'cyclotetramethylene oxide', 'diethylene oxide', 'tetra-methylene oxide'),
 ('2-methylbutan-2-ol', 'CCC(C)(C)O', '2-methyl-2-butanol', 'tert-amyl alcohol', 't-amylol', 'taa', 'tert-pentyl alcohol', '2-methyl-2-butyl alcohol', 't-pentylol', 'amylene hydrate', 'dimethylethylcarbinol'),
 ('2-methylpropan-1-ol', 'CC(C)CO', 'isobutyl alcohol', 'iba', '2-methyl-1-propanol', '2-methylpropyl alcohol', 'isopropylcarbinol'),
 ('2-methylpropan-2-ol', 'CC(C)(C)O', 't-butyl alcohol', 'tert-butanol', 't-butanol', 'trimethylcarbinol', '2-methyl-2-propanol', '2m2p'),
 ('2,2,4-trimethylpentane', 'CC(C)CC(C)(C)C', 'isobutyltrimethylmethane', 'isooctane'),
 ('3-methylbutan-1-ol', 'CC(C)CCO', '3-methyl-1-butanol', '3-methylbutanol', 'i-amyl alcohol', 'isoamyl alcohol', 'isobutyl carbinol', 'isopentanol', 'isopentyl alcohol'),
 ('acetic acid', 'CC(O)=O', 'ethanoic acid', 'glacial acetic acid'),
 ('acetonitrile', 'CC#N', 'ethanenitrile', 'cyanomethane', 'ethyl nitrile', 'methanecarbonitrile', 'methyl cyanide'),
 ('benzene', 'C1=CC=CC=C1', 'benzol', '[6]annulene', 'c1ccccc1'),
 ('benzenecarbonitrile', 'N#Cc1ccccc1', 'benzonitrile', 'cyanobenzene', 'phenyl cyanide'),
 ('bromobenzene', 'BrC1=CC=CC=C1', 'phenyl bromide', 'bromobenzol', 'monobromobenzene', 'Brc1ccccc1'),
 ('butan-1-ol', 'CCCCO', '1-butanol', '1-butyl alcohol', 'butanol', 'butyl alcohol', 'n-butanol', 'n-butyl alcohol', 'butalcohol', 'butyl hydrate', 'butylic alcohol', 'butyralcohol', 'butyric alcohol', 'butyryl alcohol', '1-hydroxybutane', 'n-propylcarbinol'),
 ...
 ('chlorobenzene', 'ClC1=CC=CC=C1', 'benzene chloride', 'monochlorobenzene', 'phenyl chloride', 'chlorobenzol', 'mcb', 'Clc1ccccc1'),
 ...
 ('ethane-1,2-diol', 'OCCO', 'ethylene glycol', '1,2-ethanediol', 'ethylene alcohol', 'hypodicarbonous acid', 'monoethylene glycol', '1,2-dihydroxyethane'),
 ('ethanol', 'CCO', 'absolute alcohol', 'alcohol', 'cologne spirit', 'drinking alcohol', 'ethylic alcohol', 'etoh', 'ethyl alcohol', 'ethyl hydrate', 'ethyl hydroxide', 'ethylol',
  'grain alcohol', 'hydroxyethane', 'methylcarbinol'),
 ('ethoxybenzene', 'CCOc1ccccc1', 'ethyl phenyl ether', 'phenetole',
  'phenyl ethyl ether'),
 ('ethoxyethane', 'CCOCC', '1,1-oxybisethane', '3-oxapentane', 'diethyl ether', 'ether', 'diethyl ether', 'dether', 'ethyl ether', 'ethyl oxide', '3-oxapentane', 'diethyl oxide', 'solvent ether', 'sulfuric ether'),
 ...
 ('hexamethylphosphoramide', 'CN(C)P(=O)(N(C)C)N(C)C', 'hexamethylphosphoric acid triamide', 'hexamethylphosphoric triamide', 'hexamethylphosphorous triamide', 'hmpa', 'N,N,N\',N\',N",N"-hexamethylphosphoric triamide', 'N-bis(dimethylamino)phosphoryl-N-methyl-methanamine', 'tris(dimethylamino)phosphine oxide'),
 ('hexan-1-ol', 'CCCCCCO', '1-hexanol', 'hexanol', 'hexanol-1', 'hexyl alcohol', 'n-hexanol', 'n-hexyl alcohol'),
 ('hexane', 'CCCCCC', 'n-hexane', 'sextane'),
 ('methanedithione', 'S=C=S', 'carbon disulfide', 'carbon disulphide', '{CS2}'),
 ('methanesulfinylmethane', 'CS(C)=O', 'dimethyl sulfoxide', 'dimethyl(oxido)sulfur', 'methylsulfinylmethane', 'methyl sulfoxide', '(methanesulfinyl)methane'),
 ('methanol', 'CO', 'carbinol', 'columbian spirits', 'hydroxymethane', 'methyl alcohol', 'methyl hydrate', 'methyl hydroxide', 'methylic alcohol', 'methylol', 'pyroligneous spirit', 'wood alcohol', 'wood naphtha', 'wood spirit'),
 ...
 ('nitrobenzene', '[O-][N+](=O)C1=CC=CC=C1', 'nitrobenzol', 'oil of mirbane', '[O-][N+](=O)c1ccccc1'),
 ...
 ('oxolan-2-one', 'O=C1CCCO1', '1,4-butanolide', '2(3h)-dihydrofuranone', '4-butyrolactone',
  '4-hydroxybutanoic acid lactone', '4-hydroxybutyric acid g-lactone', 'butyrolactone', 'dihydro-2(3h)-furanone', 'γ-butyrolactone', 'gamma-butyrolactone', 'g-butyrolactone', 'gamma butyrolactone'),
 ('pentan-1-ol', 'CCCCCO', '1-pentanol', 'amyl alcohol', 'butyl carbinol', 'n-amyl alcohol', 'n-pentanol', 'n-pentyl alcohol', 'pentanol'),
 ('phenylmethanol', 'OCC1=CC=CC=C1', 'phenylcarbinol', 'benzenemethanol', 'benzyl alcohol', 'OCc1ccccc1'),
 ('piperidine', 'C1CCNCC1', 'azinane', 'hexahydropyridine', 'pentamethyleneamine', 'azacyclohexane', 'azinane'),
 ('propan-1-ol', 'CCCO', '1-propanol', 'n-propanol', 'n-propyl alcohol', 'propanol', 'propyl alcohol', 'n-proh', 'ethylcarbinol', '1-hydroxypropane', 'propionic alcohol', 'propionyl alcohol', 'propionylol', 'propyl alcohol', 'propylic alcohol', 'propylol'),
 ...
 ('propan-2-one', 'CC(C)=O', 'acetone', 'dimethyl ketone', 'dimethyl carbonyl', 'β-ketopropane', 'propanone', '2-propanone', 'dimethyl formaldehyde', 'pyroacetic spirit (archaic)', 'Ketone propane'),
 ('propanenitrile', 'CCC#N', 'cyanoethane', 'ethyl cyanide', 'propionitrile', 'propylnitrile', 'propiononitrile'),
 ('pyridine', 'C1=CC=NC=C1', 'azinine', 'azine', 'azabenzene', 'c1ccncc1'),
 ('tetrachloromethane', 'ClC(Cl)(Cl)Cl', 'carbon tetrachloride', 'benziform', 'benzinoform', 'carbon chloride', 'carbon tet', 'freon-10', 'freon 10',
  'refrigerant-10', 'halon-104', 'methane tetrachloride', 'methyl tetrachloride', 'perchloromethane', 'tetraform', 'tetrasol'),
 ('tetrahydrothiophene 1,1-dioxide', 'O=S1(=O)CCCC1', 'sulfolane', 'tetrahydrothiophene dioxide', 'tetramethylene sulfone', 'tetramethylene sulphone', 'thiacyclopentane dioxide', 'thiolane 1,1-dioxide', 'thiolane-1,1-dioxide'),
 ('toluene', 'CC1=CC=CC=C1', 'methylbenzene', 'toluol', 'methyl benzene', 'phenyl methane', 'anisen', 'Cc1ccccc1'),
 ('trichloromethane', 'ClC(Cl)Cl', 'chloroform', 'methane trichloride', 'methyl trichloride', 'methenyl trichloride', 'tcm', 'freon 20', 'freon-20', 'refrigerant-20',
  'r-20', 'un 1888'),
 ('water', 'O', '{H2O}'))
